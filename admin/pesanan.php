            ...
            <div class="row mb-2 align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right" style="background: transparent;">
                        <li class="breadcrumb-item"><a href="<?= $base_url ?>/admin/index.php" style="color: var(--primary);">Dashboard</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <?php if (isset($_SESSION['error'])): ?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert" style="border-radius: 10px; border-left: 5px solid #dc3545;">
                    <div class="d-flex align-items-center">
                ...
                <div class="card-body p-2">
                    <div class="d-flex flex-wrap align-items-center" style="gap: 6px;">
                        ...
                        <a href="<?= $base_url ?>/admin/pesanan.php?status=pending" 
                           ...
                           style="border-radius: 20px; font-weight: 600; padding: 5px 14px;">
                            Pending <span class="badge <?= $filter_status === 'pending' ? 'badge-dark' : 'badge-warning' ?> ml-1"><?= $status_counts['pending'] ?? 0 ?></span>
                        </a>
                        ...
                        <a href="<?= $base_url ?>/admin/pesanan.php?status=dibatalkan" 
                           ...
                           style="border-radius: 20px; font-weight: 600; padding: 5px 14px;">
                            Dibatalkan <span class="badge badge-danger ml-1"><?= $status_counts['dibatalkan'] ?? 0 ?></span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0" style="border-radius: 12px; overflow: hidden;">
                <div class="card-header" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); color: #fff; padding: 14px 20px;">
                    <div class="d-flex align-items-center">
                        <h3 class="card-title font-weight-bold m-0" style="font-size: 1.05rem; display: flex; align-items: center;">
                            <i class="fas fa-list mr-2"></i> Daftar Pesanan
                        </h3>
                        <span class="badge badge-light ml-3 font-weight-bold" style="color: var(--primary); border-radius: 20px; font-size: 0.85rem; padding: 5px 14px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0" style="width: 100%;">
                            <thead style="background: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                                <tr>
                                    <th style="padding: 14px 16px; font-weight: 700; font-size: 0.85rem; color: #475569; width: 130px;">No. Pesanan</th>
                                    <th style="padding: 14px 16px; font-weight: 700; font-size: 0.85rem; color: #475569; width: 170px;">Customer</th>
                                    <th style="padding: 14px 16px; font-weight: 700; font-size: 0.85rem; color: #475569; min-width: 220px;">Alamat Pengiriman</th>
                                    <th style="padding: 14px 16px; font-weight: 700; font-size: 0.85rem; color: #475569; width: 150px;">Tanggal Pesan</th>
                                    <th style="padding: 14px 16px; font-weight: 700; font-size: 0.85rem; color: #475569; width: 140px;">Total Bayar</th>
                                    <th style="padding: 14px 16px; font-weight: 700; font-size: 0.85rem; color: #475569; width: 130px;">Status</th>
                                    <th style="padding: 14px 16px; font-weight: 700; font-size: 0.85rem; color: #475569; width: 160px; text-align: center;">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if (!empty($orders)): ?>
                                    ...
                                    <tr style="border-bottom: 1px solid #f1f5f9;">
                                        ...
                                        <td style="padding: 14px 16px; vertical-align: middle;">
                                            <span style="font-weight: 800; color: #1e293b; font-family: monospace; font-size: 0.95rem;">
                                        ...
                                        <td style="padding: 14px 16px; vertical-align: middle;">
                                            ...
                                            <div class="text-muted" style="font-size: 0.8rem; margin-top: 2px;">
                                                <i class="fas fa-phone-alt text-success mr-1" style="font-size: 0.75rem;"></i>
                                        ...
                                        <td style="padding: 14px 16px; vertical-align: middle;">
                                            ...
                                            <div style="color: #334155; font-size: 0.88rem; line-height: 1.45;">
                                                <i class="fas fa-map-marker-alt text-danger mr-1" style="font-size: 0.8rem;"></i>
                                        ...
                                        <td style="padding: 14px 16px; vertical-align: middle;">
                                            ...
                                            <div class="text-muted" style="font-size: 0.78rem;">
                                                <i class="far fa-clock mr-1"></i> <?= date('H:i', strtotime($order['tanggal'])) ?> WIB
                                            </div>
                                        </td>
                                        ...
                                        <td style="padding: 14px 16px; vertical-align: middle; text-align: center;">
                                            <div class="d-inline-flex align-items-center" style="gap: 6px;">
                                                ...
                                                <button type="button" 
                                                        ...
                                                        data-toggle="modal" 
                                                        data-target="#detailModal<?= $order['id_order'] ?>" 
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right shadow-sm" style="border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.85rem;">
                                                        <div class="dropdown-header font-weight-bold" style="font-size: 0.72rem; text-transform: uppercase; color: #94a3b8;">
                                                            Pilih Status Baru:
                                                        </div>
                                        ...
                                        <td colspan="7" class="text-center py-5">
                                            <div class="text-muted">
                                                ...
                                                <?php if (!empty($filter_status)): ?>
                                                    <a href="<?= $base_url ?>/admin/pesanan.php" class="btn btn-sm btn-primary mt-3" style="border-radius: 20px;">
                                                        Lihat Semua Pesanan
                                                    </a>
                                                <?php endif; ?>
                                            </div>
    ...
    <div class="modal fade" id="detailModal<?= $order['id_order'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content" style="border-radius: 14px; overflow: hidden; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                <!-- Modal Header -->
                <div class="modal-header" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); color: #fff; padding: 16px 24px;">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small style="opacity: 0.85;">Dipesan pada: <?= date('d F Y, H:i', strtotime($order['tanggal'])) ?> WIB</small>
                        </div>
                    </div>
                ...
                <div class="modal-body" style="padding: 24px;">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <div class="p-3" style="background: #f8fafc; border-radius: 10px; border: 1px solid #e2e8f0; height: 100%;">
                                <h6 class="font-weight-bold text-muted mb-3" style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.5px;">
                                ...
                                <div class="text-muted mb-1" style="font-size: 0.9rem;">
                                    <i class="fas fa-envelope mr-2 text-secondary"></i> <?= htmlspecialchars($order['email'] ?? '-') ?>
                                </div>
                                <div class="text-muted" style="font-size: 0.9rem;">
                                    <i class="fas fa-phone mr-2 text-success"></i> <?= htmlspecialchars($order['nomor_telepon'] ?? '-') ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Item Pesanan Table -->
                    <h6 class="font-weight-bold text-muted mb-2" style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.5px;">
                    ...
                    <div class="table-responsive" style="border-radius: 8px; border: 1px solid #e2e8f0;">
                        <table class="table table-sm mb-0">
                            <thead style="background: #f1f5f9;">
                                <tr>
                                    <th style="padding: 10px 14px; font-weight: 700; color: #475569; width: 45%;">Produk</th>
                                    <th style="padding: 10px 14px; font-weight: 700; color: #475569; text-align: center; width: 15%;">Jumlah</th>
                                    <th style="padding: 10px 14px; font-weight: 700; color: #475569; text-align: right; width: 20%;">Harga Satuan</th>
                                    <th style="padding: 10px 14px; font-weight: 700; color: #475569; text-align: right; width: 20%;">Subtotal</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                <tr style="border-bottom: 1px solid #f1f5f9;">
                                    <td style="padding: 10px 14px; vertical-align: middle;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span style="font-weight: 600; color: #1e293b;"><?= htmlspecialchars($item['nama_produk']) ?></span>
                                        </div>
                                    </td>
                                    <td style="padding: 10px 14px; vertical-align: middle; text-align: center; font-weight: 700;">
                                        <?= $item['jumlah'] ?>x
                                    </td>
                                    <td style="padding: 10px 14px; vertical-align: middle; text-align: right; color: #475569;">
                                        <?= formatRupiah($item['subtotal'] / max(1, $item['jumlah'])) ?>
                                    </td>
                                    <td style="padding: 10px 14px; vertical-align: middle; text-align: right; font-weight: 700; color: #1e293b;">
                            ...
                            <tfoot style="background: #f8fafc; border-top: 2px solid #e2e8f0;">
                                <tr>
                                    <td colspan="3" style="padding: 12px 14px; text-align: right; font-weight: 700; color: #1e293b; font-size: 1rem;">
                                        Total Pembayaran:
                                    </td>
                                    <td style="padding: 12px 14px; text-align: right; font-weight: 800; color: var(--green); font-size: 1.15rem;">
                                        <?= formatRupiah($order['total']) ?>
                                    </td>
                                </tr>
                            </tfoot>
                ...
                <!-- Modal Footer -->
                <div class="modal-footer d-flex justify-content-between" style="background: #f8fafc; padding: 14px 24px; border-top: 1px solid #e2e8f0;">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-outline-secondary dropdown-toggle" data-toggle="dropdown" style="border-radius: 6px; font-weight: 600;">
                            <i class="fas fa-exchange-alt mr-1"></i> Ubah Status Pesanan Ini
                        </button>
                        <div class="dropdown-menu shadow-sm" style="border-radius: 8px;">
                            <a class="dropdown-item py-2" href="<?= $base_url ?>/admin/proses/proses_pesanan.php?action=update&id=<?= $order['id_order'] ?>&status=pending">
                                <i class="fas fa-clock text-warning mr-2"></i> Pending
                            </a>
                            <a class="dropdown-item py-2" href="<?= $base_url ?>/admin/proses/proses_pesanan.php?action=update&id=<?= $order['id_order'] ?>&status=diproses">
                                <i class="fas fa-sync-alt text-info mr-2"></i> Diproses
                            </a>
                            <a class="dropdown-item py-2" href="<?= $base_url ?>/admin/proses/proses_pesanan.php?action=update&id=<?= $order['id_order'] ?>&status=dikirim">
                                <i class="fas fa-truck text-primary mr-2"></i> Dikirim
                            </a>
                            <a class="dropdown-item py-2" href="<?= $base_url ?>/admin/proses/proses_pesanan.php?action=update&id=<?= $order['id_order'] ?>&status=selesai">
                                <i class="fas fa-check-circle text-success mr-2"></i> Selesai
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item py-2 text-danger" href="<?= $base_url ?>/admin/proses/proses_pesanan.php?action=update&id=<?= $order['id_order'] ?>&status=dibatalkan">
                                <i class="fas fa-times-circle mr-2"></i> Dibatalkan
                            </a>
                        </div>
                    </div>
