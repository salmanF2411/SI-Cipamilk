...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-weight: 800;"><i class="fas fa-calendar-check mr-2"></i> Kelola
                        Subscription</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header"
                    ...
                    <h3 class="card-title" style="font-weight: 700;"><i class="fas fa-list mr-2"></i> Semua Subscription
                    </h3>
                </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php foreach ($subscriptions as $sub): ?>
                                    <tr>
                                        <td><strong>#SUB-<?= str_pad($sub['id_subscription'], 4, '0', STR_PAD_LEFT) ?></strong>
                                        </td>
                                        <td><?= htmlspecialchars($sub['nama']) ?></td>
                                        <td><?= htmlspecialchars($sub['nama_produk']) ?></td>
                                        <td><span class="badge badge-info"
                                                style="border-radius: 20px; padding: 0.3rem 0.6rem;"><?= ucfirst($sub['periode']) ?></span>
                                        </td>
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="<?= $base_url ?>/admin/proses/proses_subscription.php?action=update&id=<?= $sub['id_subscription'] ?>&status=aktif">Aktif</a>
                                                    <a class="dropdown-item"
                                                        href="<?= $base_url ?>/admin/proses/proses_subscription.php?action=update&id=<?= $sub['id_subscription'] ?>&status=selesai">Selesai</a>
                                                    <a class="dropdown-item text-danger"
                                                        href="<?= $base_url ?>/admin/proses/proses_subscription.php?action=update&id=<?= $sub['id_subscription'] ?>&status=dibatalkan">Dibatalkan</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <?php if (empty($subscriptions)): ?>
                                    <tr>
                                        <td colspan="7" class="text-center text-muted py-4">Belum ada subscription</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
