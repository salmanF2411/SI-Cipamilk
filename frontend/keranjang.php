                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <strong
                                                        style="font-family: var(--font-heading);"><?= htmlspecialchars($item['nama_produk']) ?></strong>
                                                    <br><small
                                        ...
                                        <td>
                                            <form action="<?= $base_url ?>/frontend/proses/proses_keranjang.php" method="POST"
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-cipamilk qty-minus"
                                                    style="padding: 0.2rem 0.5rem; font-size: 0.8rem;">-</button>
                                                <input type="number" name="jumlah" value="<?= $item['jumlah'] ?>" min="1"
                                                    max="<?= $item['stok'] ?>" class="qty-input mx-1"
                                                    onchange="this.form.submit()">
                                                <button type="button" class="btn btn-sm btn-outline-cipamilk qty-plus"
                                                    style="padding: 0.2rem 0.5rem; font-size: 0.8rem;">+</button>
                                            </form>
                                        </td>
                                        ...
                                        <td>
                                            <a href="<?= $base_url ?>/frontend/proses/proses_keranjang.php?action=delete&id_cart=<?= $item['id_cart'] ?>"
                                                class="btn btn-sm" style="color: var(--danger);"
