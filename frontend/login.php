        ...
        <div class="auth-card">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"
                                style="background: #FAFAFA; border: 2px solid var(--border); border-right: none; border-radius: var(--radius-sm) 0 0 var(--radius-sm);">
            ...
            <div class="text-center mt-4">
                <p style="color: var(--text-muted); font-size: 0.9rem;">
                    Belum punya akun?
                    <a href="<?= $base_url ?>/frontend/register.php"
                        style="font-weight: 700; color: var(--primary);">Daftar Sekarang</a>
                </p>
