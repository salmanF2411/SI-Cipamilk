        ...
        <div class="auth-card" style="max-width: 520px;">
            ...
            <form action="<?= $base_url ?>/frontend/proses/proses_register.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control form-control-cipamilk"
                        placeholder="Masukkan nama lengkap" required>
                </div>

                <div class="form-group">
                    <label class="form-label-cipamilk">Email</label>
                    <input type="email" name="email" class="form-control form-control-cipamilk"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control form-control-cipamilk"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" name="konfirmasi_password" class="form-control form-control-cipamilk"
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" class="form-control form-control-cipamilk" rows="3"
            ...
            <div class="text-center mt-4">
                <p style="color: var(--text-muted); font-size: 0.9rem;">
                    Sudah punya akun?
                    <a href="<?= $base_url ?>/frontend/login.php"
                        style="font-weight: 700; color: var(--primary);">Masuk</a>
                </p>
